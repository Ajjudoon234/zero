...
def start_attack_reply(message, target, port, time):
    ...
    # Countdown ka message send karenge
    ...
    # Countdown timer
    for remaining_time in range(time, 0, -1):
    ...
    # Jab time khatam ho jaye, ussi message ko "Attack Finished" me change kar denge
    bot.edit_message_text(
        chat_id=message.chat.id,
        message_id=countdown_message.message_id,
        text=(
